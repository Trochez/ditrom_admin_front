Vue.component('promotion',{
 ...
 data () {
    ...
    path_img:properties.protocol_img+properties.pathimg+promotion.img+properties.rest_img
	 }
  },
  created(){
